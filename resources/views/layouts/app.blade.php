...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md shadow-sm navbar navbar-dark navbar-color-ufps">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    <img class="logo-ufps" src="{{ asset('img/logo_vertical.jpg') }}">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <!-- Right Side Of Navbar -->
                     <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item"><a class="nav-link" href="{{route('correo.index')}}">Enviar Correo</a></li>
